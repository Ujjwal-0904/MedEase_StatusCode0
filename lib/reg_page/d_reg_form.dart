...
class Regd extends StatefulWidget {
  const Regd({
    Key? key,
  }) : super(key: key);

  @override
  State<Regd> createState() => _RegdState();
}

class _RegdState extends State<Regd> {
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    prefixIcon: Padding(
                      ...
                      child: Image.asset("assets/icons/user.png",height: 16,),
                    ),
                  ),
                ),
              ),
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    prefixIcon: Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 8),
                      child: Image.asset("assets/icons/p.png",height: 16,),
                    ),
                  ),
                ),
              ),
